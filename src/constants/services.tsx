...
export const services = [   
    ...
    },
    {
      ...
      target: ["Functional consultants and technical consultants for up skilling"," Business Analyst and process owners to bridge needs with capabilities", "Project team members to contribute to implementation, testing and rollout phases effectively","End users, to perform daily tasks with Compliance", " A company that just completes restructuring"],
      detailsLink: "#",
      category: ["Services"],
    ...
    },
    {
      ...
      benefits: ["Increased Customer Satisfaction", "Streamlined Operations", "Better Resource Management", "Accurate Data Capture", "Improved Customer Support","Offers a cost-effective and easy-to-use channel for customer engagement", " Integrates USSD with SAP back-end systems to simplify processes.", "Reduces the need for manual customer service tasks.", "Enables customers to submit meter readings directly through USSD", "Allows customers to create notifications and receive updates on service requests."],
      target: [" Municipalities and utilities providers, to enable real time customer feedback","SAP System Administrators","Customers without smart phones","Field service Teams", "Finance and Billing department","Customer Support Teams"],
      detailsLink: "#",
      category: ["Products"],
    ...
    },
    {
      ...
      benefits: ["Quickly take advantage of our solutions, making progress and improving efficiency.", "Connect with customers through self-service, chatbot, phone, email, SMS, USSD, Facebook, Twitter, and WhatsApp, meeting them where they are.", "Improve customer satisfaction and address issues promptly with a clear view of interactions.", "Simplify operations with a cloud-based setup, reducing the need for extensive internal systems.", "Allow customers to create notifications easily and stay informed about service requests.","Fast Implementation", "Omnichannel Capabilities", "Complete Customer View", "Cloud-Based Setup", " Real-Time Reporting"],
      target: ["Utilities companies and Municipalities","Customer service Agents","End users","IT and System Administrators","Operations and Support Managers","Field technician and Maintenance teams","Executives and Decision Maker"],
      detailsLink: "#",
      category: ["Products"],
    ...
    },
    {
      ...
      benefits: ["Personnel can quickly scan barcodes on assets using mobile devices, enabling immediate identification and logging. Real-time data entry reduces delays in updating asset records, streamlining the process.", "The mobile application eliminates paper trails and digitises the asset management process, reducing errors associated with manual data entry.", "Automated scanning reduces the risk of human errors, ensuring consistent identification of assets and minimising discrepancies.","Improve accuracy and efficiency by using digital tools", "Reduce paperwork and streamline asset management", "Achieve accurate reporting"],
      target: [" Asset Management Teams","Finance Compliance departments","IT and system Administrators", "Field Personnel and Technicians","Procurement and inventory managers", "Executive and decision makers"],
      detailsLink: "#",
      category: ["Products"],
    ...
    },
    {
      ...
      benefits: ["Improved Efficiency","Automates HR processes, saving time and reducing manual work.", "Enhances the employee experience with intuitive tools for performance management and development.", "Provides analytics and reporting to support informed decision-making and HR planning.", "Can be quickly deployed and adjusted to meet changing organisational needs.","Employee Engagement", "Informed Decision-Making","Flexible Deployment"],
      target: [" Field Personnel and technicians", "Asset Managers and Auditors","Finance and compliance teams","IT and ERP Administrators", "Procurement and inventory teams","Executives and decision makers"],
      detailsLink: "#",
      category: ["Products"],
    ...
    },
    {
      ...
      benefits: ["Easily customizable to fit to your operational framework", "Create a solution that fits seamlessly into your operational framework, enhancing productivity and accuracy in the field", "Synchronize system and field data in real-time, ensuring seamless integration and up-to-date information across your operations.", "Operate independently, eliminating the need for third-party platforms and ensuring greater control, security, and reliability for your operations.","Monitor, manage, and optimize field operations with unparalleled efficiency.","Align system and field meter data instantly with process manager", "Eliminate dependency on third-party platforms", "Get real-time insights of field services in process manage"],
      target: ["Operations Managers", "SAP IS-U/FICA Administrators", "Compliance & Audit Teams", "IT & System Architects", "Executives & Decision Makers"],
      detailsLink: "#",
      category: ["Products"],
    ...
    },
    {
      ...
      target: [" Municipal Finance Departments","Procurement & Supply Chain Teams","Customer Service & CRM Teams","Project & Facilities Managers","IT & ERP Administrators", "Executives & Governance Bodies"],
      detailsLink: "#",
      category: ["Solutions"],
    ...
    },
    {
      ...
      benefits: ["Improved Efficiency","Automates HR processes, saving time and reducing manual work.", "Enhances the employee experience with intuitive tools for performance management and development.", " Provides analytics and reporting to support informed decision-making and HR planning.", "Can be quickly deployed and adjusted to meet changing organisational needs.", "Employee Engagement", "Informed Decision-Making","Flexible Deployment"],
      target: [" HR Professionals & Administrators","Employees","Managers & Team Leads", "Executives & Strategic Planners","IT & ERP Integration Teams", "Public Sector & Municipal Leaders"],
      detailsLink: "#",
      category: ["Solutions"],
    ...
    },
    {
      ...
      target: [" Utilities companies","Finance and billing teams", "End users", "Executives and decision makers"],
      detailsLink: "#",
      category: ["Solutions"],
    ...
    },
    {
      ...
      target: ["Clients who experience: Challenges related to manual meter reading, difficulty accessing meter premises, lengthy meter reading and billing cycles, Incidents of electricity theft, tampering, or meter failure and Revenue collection challenges", "Utilities providers","Finance and billing departments","End users"],
      detailsLink: "#",
      category: ["Solutions"],
    ...
    },
    {
      ...
      target: ["Our smart metering solution helps address: Delays and challenges linked to manual meter reading, Issues accessing meter premises, Lengthy meter reading and billing cycles, Electricity theft, tampering, and meter failure, Under-collection of revenue"," Utilities providers","Technical and field teams", "Finance and billing departments","End customers"],
      detailsLink: "#",
      category: ["Solutions"],
