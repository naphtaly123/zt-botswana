...
>
    ...
    <div className="mx-auto pt-24 px-6 md:flex md:items-center relative z-10" id="hero">
        {/* Hero Text */}
        <div className="md:w-1/2 text-white py-1">
            <h3 className="text-lg">ZIMELE TECHNOLOGIES BOTSWANA</h3>
            <h1 className="text-6xl font-bold tracking-tight text-white sm:text-6xl">Ultimate
            <span className="text-sky-500"> IT Solutions </span>for <span className="text-sky-500"> Modern </span>Businesses<span className="text-sky-500">.</span>
            </h1>
