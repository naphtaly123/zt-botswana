...
function JoinUs() {
  ...
  return (
    <>
      ...
      <section
        id="_"
        className="relative min-h-screen flex items-center justify-center gradient-bg overflow-hidden bg-[#6496B3]"
      >
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
          <div className="animate-fadeInUp">
            ...
            <p className="text-xl sm:text-xl text-indigo-100 mb-8 max-w-3xl mx-auto">
              Join a team that's driving innovation, creating impact, and
              growing together. Explore career opportunities that match your
              passion and purpose.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Join our comprehensive IT Capacity Building Programme designed to
              equip individuals and teams with essential digital skills.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                What is the IT Capacity Building Programme?
              </h3>
              <p className="text-gray-600 mb-6">
                Our Zimele Technologies IT Capacity Building Programme is a
                comprehensive training initiative that aims to equip individuals
                and teams with the necessary digital skills to succeed in
                today's fast-paced technology landscape.
                <br />
                We have a team of experienced trainers who will guide you
                through the programme, ensuring you gain hands-on experience and
                practical knowledge.
              </p>
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-gray-700 md:text-lg">
            From job-ready skills for individuals to workforce development
            solutions for companies, this programme strengthens IT capacity
