...
function AboutPage() {
  ...
  return (
    <>
      <div id="_" className="relative z-0 bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
  ...
  <div className="flex flex-col items-center text-center">
    ...
    <div className="mt-5">
      <h3 className="text-lg font-medium text-gray-900">What we do</h3>
      <p className="mt-2 text-base text-gray-500">
        We offer SAP based solutions that help organization’s maximize revenue
        collection, profitability, and ERP software to run organizations.
      </p>
    </div>
  </div>
  ...
  <div className="flex flex-col items-center text-center">
    ...
    <div className="mt-5">
      <h3 className="text-lg font-medium text-gray-900">How we work</h3>
      <p className="mt-2 text-base text-gray-500">
  ...
  <div className="flex flex-col items-center text-center">
    ...
    <div className="mt-5">
      <h3 className="text-lg font-medium text-gray-900">Where we work</h3>
      <p className="mt-2 text-base text-gray-500">
        We envision a world where technology is used to solve the most pressing
        issues facing humanity and improve people's lives.
      </p>
    </div>
  </div>
</div>
