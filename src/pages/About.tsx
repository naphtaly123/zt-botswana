...
function AboutPage() {
  ...
  return (
    <>
      ...
      <div id="_" className="relative z-0 bg-gradient-to-r from-purple-600 to-blue-600 min-h-screen text-white overflow-hidden">
  <div className="absolute inset-0">
    <img
      src={team}
      alt="Background Image"
  ...
  <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-4 py-16 pt-64">
    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4 max-w-4xl">
      Driven by Passion, Powered by Expertise.
    </h1>
    <p className="text-base md:text-lg text-gray-300 mb-8 max-w-3xl px-4">
      We're your partners in innovation. With a shared vision and diverse
      expertise, we deliver solutions that transform businesses and
      inspire growth.
    </p>
      ...
      {/*OUR HISTORY*/}
      <section className="flex flex-col sm:flex-row items-center px-4 sm:px-10 lg:px-20 py-10">
  <div className="w-full sm:w-1/3 p-4 sm:p-10">
    <div className="image object-center text-center">
      <img src="https://i.imgur.com/WbQnbas.png" className="max-w-full h-auto" alt="Company History" />
    </div>
  </div>
  <div className="w-full sm:w-2/3 p-4 sm:p-5">
    <div className="text">
      ...
      <p className="text-gray-700 pb-4 text-sm sm:text-base">
        ...
        and Public sectors predominantly SAP solutions. <br /><br />
      ...
      <p className="text-gray-700 pb-4 text-sm sm:text-base">
        <b>OUR MISSION:</b> Our commitment is to transform and empower
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 sm:gap-8">
      ...
      <div className="flex flex-col items-center text-center p-4">
        <div className="flex items-center justify-center h-16 w-16 rounded-md bg-blue-50 p-3">
          <svg fill="#6496B3" viewBox="0 0 64 64" className="w-10 h-10">
        ...
        <div className="mt-4">
          <h3 className="text-sm font-medium text-gray-700">Client-centric</h3>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center text-center p-4">
        <div className="flex items-center justify-center h-16 w-16 rounded-md bg-blue-50 p-3">
          <svg viewBox="0 0 512 512" fill="#6496B3" className="w-10 h-10">
        ...
        <div className="mt-4">
          <h3 className="text-sm font-medium text-gray-700">Strong work ethic</h3>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center text-center p-4">
        <div className="flex items-center justify-center h-16 w-16 rounded-md bg-blue-50 p-3">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 3.73169L19.5 5.39836V12.75C19.5 15.6371 17.5419 18.9972 12.2605 20.9533L12 21.0498L11.7395 20.9533C6.45811 18.9972 4.5 15.6371 4.5 12.75V5.39836L12 3.73169ZM6 6.60161V12.75C6 14.8245 7.3659 17.6481 12 19.4479C16.6341 17.6481 18 14.8245 18 12.75V6.60161L12 5.26828L6 6.60161Z" fill="#6496B3"></path>
          </svg>
        </div>
        <div className="mt-4">
          <h3 className="text-sm font-medium text-gray-700">Integrity</h3>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center text-center p-4">
        <div className="flex items-center justify-center h-16 w-16 rounded-md bg-blue-50 p-3">
          <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-10 h-10">
            <path d="M12 21C16.4183 21 20 17.6439 20 13.504C20 9.76257 17.9654 6.83811 16.562 5.44436C16.3017 5.18584 15.8683 5.30006 15.7212 5.63288C14.9742 7.3229 13.4178 9.75607 11.4286 9.75607C10.1975 9.92086 8.31688 8.86844 9.83483 3.64868C9.97151 3.17868 9.46972 2.80113 9.08645 3.11539C6.9046 4.90436 4 8.51143 4 13.504C4 17.6439 7.58172 21 12 21Z" stroke="#6496B3" stroke-width="1.5"></path>
          </svg>
        </div>
        <div className="mt-4">
          <h3 className="text-sm font-medium text-gray-700">Vibrance</h3>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap items-center mt-16">
      {/* Text Content */}
      <div className="w-full md:w-7/12 lg:w-7/12 px-4 md:mr-auto md:ml-auto order-2 md:order-1">
        <p className="inline-block px-0 py-px mb-4 text-xs font-semibold tracking-wider text-teal-900 uppercase rounded-full mt-14 bg-teal-accent-400">
          MANAGING DIRECTOR
        </p>
        <h3 className="text-2xl sm:text-3xl mb-2 font-semibold leading-normal">
          ONKABETSE MONNAWAPULA
        </h3>
        <div className="text-base sm:text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-600">
          Onkabetse Monnawapula is a seasoned executive with over a decade
          of experience in accounting and information technology.
          Currently serving as the Managing Director of Zimele
          Technologies Botswana, he brings a wealth of knowledge in
      ...
      {/* Image */}
      <div className="w-full md:w-4/12 px-4 md:mr-auto md:ml-auto mb-8 md:mb-0 order-1 md:order-2">
        <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-2 shadow-lg rounded-lg">
          <img
            src="https://res.cloudinary.com/dh3ktp1w6/image/upload/v1758003761/IMG_9993_delfzs.jpg"
            alt="Onkabetse Monnawapula"
